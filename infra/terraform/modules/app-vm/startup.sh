...
BUSCASAM_MIN_SEMANTIC_SIMILARITY=0.84
BUSCASAM_FUZZY_WORD_SIMILARITY_THRESHOLD=0.3
BUSCASAM_SEMANTIC_ONLY_TRGM_THRESHOLD=0.3
...
BUSCASAM_DOCENTE_EMAIL_ALLOWLIST=${docente_email_allowlist}

BUSCASAM_METADATA_LLM_ENABLED=${metadata_llm_enabled ? "1" : "0"}
BUSCASAM_METADATA_LLM_PROVIDER=${metadata_llm_provider}
BUSCASAM_METADATA_LLM_URL=http://localhost:11434
BUSCASAM_METADATA_LLM_MODEL=${metadata_llm_model}
BUSCASAM_VERTEX_PROJECT=${vertex_project}
BUSCASAM_VERTEX_LOCATION=${vertex_location}
