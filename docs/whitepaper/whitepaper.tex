...
La producción intelectual de la UNSAM (tesis, papers, trabajos prácticos, apuntes) hoy queda dispersa en repositorios aislados por unidad académica, carpetas compartidas y archivos personales. El conocimiento existe, pero no circula. Los estudiantes no pueden construir sobre lo ya investigado, los docentes no encuentran antecedentes, y el sector productivo no tiene cómo identificar talento o proyectos con potencial de transferencia.
...
\begin{itemize}
  \item \textbf{Reducción sustancial del tiempo de búsqueda de antecedentes} (a medir en el piloto), al reemplazar el rastreo manual de catálogos y carpetas por una consulta en lenguaje natural con filtros.
...
\medskip
\noindent\textbf{Beneficios cualitativos:} reputación institucional (la universidad como referente en democratización del conocimiento con IA), sentido de pertenencia y motivación de los estudiantes al ver su trabajo publicado y leído, y mejora de la calidad académica al reducir la redundancia de temas.
...
\begin{enumerate}
  ...
  \item \textbf{Confiabilidad de la búsqueda.} El producto es el buscador; si los resultados decepcionan, no hay segunda visita. Priorizamos relevancia verificable (juegos de consultas de prueba con resultados esperados) y degradación controlada (sin servicio semántico, la búsqueda léxica sigue de pie).
  ...
  \item \textbf{Usabilidad.} Una sola caja de búsqueda, mensajes claros cuando no hay resultados y publicación guiada paso a paso. Las tres anteriores son condiciones de existencia del producto; esta es condición de crecimiento.
...
\rowcolor{rowtint}
Red, registro de imágenes, secretos, backups & $\sim$8 \\
...
La UNSAM produce conocimiento que hoy no circula, y el costo de esa invisibilidad se paga en investigación redundante, oportunidades de vinculación perdidas y trabajo estudiantil que muere en una carpeta. BUSCASAM ataca el problema en su raíz (el costo de publicar y el costo de encontrar) y lo hace con una primera versión funcional, probada y operativa en \href{https://buscasam.org}{buscasam.org}, construida por un equipo de cuatro personas (con la implementación en código concentrada en unas dos semanas de trabajo intensivo asistido por IA) y con un costo de operación del orden de USD 90 mensuales.
...
\begin{tikzpicture}[node distance=8mm and 10mm]
  ...
  \node[store, below=9mm of api] (pg) {PostgreSQL 16};
...
\begin{itemize}
  ...
  \item \textbf{Puertas de calidad:} ningún cambio se integra sin revisión de pares y suite completa en verde; ninguna versión sale a producción sin la batería completa, auditoría de dependencias y validación de migraciones.
